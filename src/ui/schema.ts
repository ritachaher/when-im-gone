...
export const SCHEMAS: Record<string, SectionSchema> = {
  ...
  digital: {
    intro: 'Email and other online accounts. List them; don\u2019t store passwords — use a password manager.',
    rootCallout: {
      type: 'accent',
      text: 'Golden rule: never write full passwords in this book. Use a password manager (1Password, Bitwarden, etc.) and record only which manager you use and how your trusted person can access it.',
    },
    cards: [
      {
        kind: 'single',
        ...
        fields: [
          { id: 'manager', label: 'Which manager', type: 'text', placeholder: '1Password, Bitwarden, \u2026' },
          { id: 'kitLocation', label: 'Emergency Kit location', type: 'text', placeholder: 'e.g. Home safe, envelope marked \u201CDigital\u201D' },
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'primaryRecovery', label: 'Provider recovery path', type: 'text', placeholder: 'e.g. Google Inactive Account Manager' },
          { id: 'secondary', label: 'Secondary email', type: 'email' },
          { id: 'work', label: 'Work email', type: 'email' },
        ],
      },
      {
        kind: 'repeat',
        ...
        hint: 'What should happen to each account? (memorialise, delete, transfer)',
        fields: [
          { id: 'service', label: 'Service', type: 'text', placeholder: 'Facebook, Instagram, LinkedIn\u2026' },
          { id: 'handle', label: 'Handle / username', type: 'text' },
          { id: 'wish', label: 'What should happen', type: 'select', options: ['Memorialise', 'Delete', 'Transfer to someone', 'Leave as-is'] },
